...
public:
    ...
    int getCount(int destination, int startTime, int endTime) {
        ...
        int leftIdx = lower_bound(begin(it->second), end(it->second), startTime) - begin(it->second);
        int rightIdx = upper_bound(begin(it->second), end(it->second), endTime) - begin(it->second);
